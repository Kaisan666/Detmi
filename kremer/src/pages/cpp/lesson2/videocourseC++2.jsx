                    ...
                    <div className="container1">
                        <div className="top__wrapper">
                            <div className="zaeb">
                                ...
                                <h1 className="greetings">Условные конструкции. Операторы if-else, switch-case</h1>
